...
protected $accountSuffix =  "";//"@test.slimcrm.com";
protected $baseDn = "";//"DC=test,DC=slimcrm,DC=com";
protected $domainControllers = array();//array("50.57.184.4");
protected $adminUsername = "";//"administrator";
protected $adminPassword = "";//"CTL-tmp-domaintestD5v5mqV6D";
