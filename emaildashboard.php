...
$ajax->AjaxifyObjects(array("emaildash","global_task","flags","smtp","casecreation"));
...
$page -> setPageTitle("EMAIL DASH BOARD");
...
$page -> setExtJavaScripts12('<script type="text/javascript" src="upload_attachment/jquery-1.4.2.min.js"></script>');
$page -> setExtJavaScripts13('<script type="text/javascript" src="upload_attachment/swfobject.js"></script>');
$page -> setExtJavaScripts14('<script type="text/javascript" src="upload_attachment/jquery.uploadify.v2.1.4.min.js"></script>');
...
<div id="emaildashboard_full_screen">
	...
	<div id="form_main">
	 ...
	 <div id="emaildashboard_mail_info">
	   <div id="show_info" style="width:40%">
		  <?php echo $emaildash->display_email_by_module(); ?>
	   </div>
	   <div id="email_content" style="float:right; width:58%; background-color:#FFFFFF;">
