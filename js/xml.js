...
//Thanks to http://www.openjs.com/scripts/xml_parser/ for this script
			...
			for(var i=0; i<xmlDoc.childNodes.length; i++) {//Go thru all the child nodes.
				...
				if(temp) {
					...
					if(assoc && arr_count == 1) {
                                            if(arr.hasOwnProperty(key)) { 	//If another element exists with the same tag name before,
