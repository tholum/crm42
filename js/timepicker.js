  ...
  function selectTime(ctl,ctl2,type) {
    var leftpos=0
    var toppos=0
    ...
    bShow = true;
	if(type=='pm')
	{document.getElementById("iconAM").src="timePickerImages/am2.gif";document.getElementById("iconPM").src="timePickerImages/pm1.gif";refreshTimePicker(1);}
	else if(type=='am')
	{document.getElementById("iconAM").src="timePickerImages/am1.gif";document.getElementById("iconPM").src="timePickerImages/pm2.gif";refreshTimePicker(0);}
