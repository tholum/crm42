...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'This week', dateStart: function(){ return Date.parse('today+6').setDate(1);  }, dateEnd: 'today+6' },
			{text: 'Next week', dateStart: function(){ return Date.parse('today+6').setDate(1);  }, dateEnd: 'today+6' },
			//{text: 'Next week', dateStart: function(){ var x= Date.parse('today'); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
			{text: 'Later', dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
			//{text: 'Tomorrow', dateStart: 'Tomorrow', dateEnd: 'Tomorrow' },
		...
		arrows: false,
		posX:	550, // x position
		posY: 200 + rangeInput.outerHeight(), // y position
		appendTo: 'body',
		onClose: function(){},
		onOpen: function(){},
		onChange: function(){},
