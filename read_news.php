...
$ajax->AjaxifyObjects(array("news"));  
...
?>
<div class="form_main">
	<div><a href="news.php"><img src="images/new_news.gif" border="0" alt="Add new News" /></a></div>
</div>
<?php
}
?>
