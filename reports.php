...
<div id="content_column_header">Report Builder</div>
<?php 
if($_REQUEST[search_report_id]){ 
	echo $report_builder->showReportPage($_REQUEST[search_report_id]);
	?><div id="div_result_report_builder"></div><?php
	}
else {?>
	<div class="form_main" id="div_report_list">
	<?php echo $report_builder->showReports(); ?>
	</div>
	<?php }?>
<?php
