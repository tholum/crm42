...
class ReprtBuilder{
	...
	function returnSelection($table_name,$i=''){
		ob_start();		
	...
	function showAddOption($table_name,$i=''){	    
		ob_start();
		...
		<tr>
			...
			<td width="30%">
				<input id="field_text" name="field_text" />
		  </td>
			<td width="20%">
			...
			<td width="20%">
				<select name="search_type" id="search_type_<?php echo $i; ?>" style="display:none">
					<option value="">--Select--</option>
					<option value="timestamp">Timestamp</option>
					<option value="text_num">Text/Num</option>
					<option value="range">Range</option>
					<option value="dropdown">Dropdown</option>
					<option value="cal_range">Caleder Range</option>
				</select>&nbsp;
			<?php 
	...
	function show_search($table_name='',$report_title='',$field_name=array(),$field_text=array(),$field_type=array()){
		ob_start();
		?>
		<script>
	...
	function addCrossTable($table='',$i=''){
		ob_start();
		$sql = "show tables FROM ".DATABASE_NAME;
		$result = $this->db->query($sql,__FILE__,__lINE__);
		?>
		...
		<td width="10%">
		<?php
		echo $this->returnTableFields($table,'link_field','link_field'.$i);
		?>		</td>
		<th width="5%">DB</th>
		<td width="15%">
		...
		<th width="5%">Col</th>
		<td width="15%"><div id="link_column_div<?php echo $i;?>"></div></td>
		<td width="15%">
			<input id="field_text_link<?php echo $i;?>" name="field_text_link" />
		</td>
		<td width="15%">
		...
		<td width="10%">
			<select name="search_type_link" id="search_type_link<?php echo $i; ?>" style="display:none;" >
				<option value="">--Select--</option>
				<option value="timestamp">Timestamp</option>
				<option value="text_num">Text/Num</option>
				<option value="range">Range</option>
	...
	function returnTableFields($table='',$element_name='',$element_id=''){
		ob_start();
	...
	function show_cross_search($table_name='',$link_fields=array(),$link_table_names=array(),$link_cols=array(),$link_field_texts=array(),$link_field_types=array()){
		ob_start();
		?>
		<table class="table"> 
		<?php
	...
	function returnSearchResult($limit='all',$table_name='',$report_title='',$fields=array(),$fieldHeads=array(),$field_types=array(),$field_values=array(),$link_fields=array(),$link_table_names=array(),$link_cols=array(),$link_field_texts=array(),$link_field_types=array(),$link_search_patterns=array()){
...
*/
		...
		foreach($link_table_names as $link_table_name){
		   ...
		   $sql .=" and a."."$link_fields[$i] = a".($i+1)."."."$link_fields[$i]";
		   $i++;
		 }
	...
	function saveSearch($table_name='',$report_title='',$fields=array(),$fieldHeads=array(),$field_types=array(),$link_fields=array(),$link_table_names=array(),$link_cols=array(),$link_field_texts=array(),$link_field_types=array()){
...
*/		
	...
	function showReportPage($search_report_id=''){
		...
		echo $this->show_search_user($table_name,$report_title,$fields,$fieldHeads,$field_types,$link_fields,$link_table_names,$link_cols,$link_field_texts,$link_field_types);
	...
	function show_search_user($table_name='',$report_title='',$field_name=array(),$field_text=array(),$field_type=array(),$link_fields=array(),$link_table_names=array(),$link_cols=array(),$link_field_texts=array(),$link_field_types=array()){
		ob_start();
/*		echo '<br>table_name';
		echo $table_name;
