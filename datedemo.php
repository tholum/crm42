...
<IMG SRC="timePickerImages/timepicker.gif" BORDER="0" ALT="Pick a Time!" ONCLICK="selectTime(this,timepicker1)" STYLE="cursor:hand"
>
<input type="button" onClick="javascript: alert(document.getElementById('timepicker1').value)" />
