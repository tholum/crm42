...
WHERE a.order_id = '$module_id' AND e.type_id = '$type_id'";
...
while( $row = $this->db->fetch_assoc($result)){
    ...
    $iv[] = $row;
    $sql = "UPDATE erp_inventory_details SET allocated = allocated + '" . $total_used . "' WHERE inventory_id = '" . $row["inventory_id"] . "'";
    $sql_arr[] = $sql;
    $this->db->query($sql);
}
//$return["stop"] = "yes";
