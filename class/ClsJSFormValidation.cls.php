	...
	*/		
	...
	class ClsJSFormValidation
	{
		function ShowJSFormValidationCode($FormName,$ControlNames,$ValidationFunctionName,$SameFields="",$ErrorMsgForSameFields="")
		{
			...
			// original line for password was: var ck_password =  /^[A-Za-z0-9!@#$%^&*()_]{6,20}$/;
			...
			$JSValidation="<script language='javascript1.2'>
							...
							var ck_number = /^\d+$/;
							var ck_double =/^[-]?([0-9]{0,}(\.[0-9]+)?|0(\.[0-9]+)?|\.[0-9]+)$/;
			...
			foreach($ControlNames as $SingleControlName) {
					switch($SingleControlName[1])
					{
						...
						case "VEmail":	$JSValidation.="
							...
							case "Double":	$JSValidation.="
											var double;
											double=document.$FormName.$SingleControlName[0].value;
											if (!ck_double.test(double) || double=='')
											{
												document.getElementById('$SingleControlName[3]').className='required';
												document.getElementById('$SingleControlName[3]').innerHTML='$SingleControlName[2]';
												document.$FormName.$SingleControlName[0].focus();			
						...
						case "UserName":	$JSValidation.="
											...
											if(!ck_username.test(username)|| 1==1)
											{
												document.getElementById('$SingleControlName[3]').className='required';
												document.getElementById('$SingleControlName[3]').innerHTML='$SingleControlName[2]';
												//document.$FormName.$SingleControlName[0].focus();			
						...
						case "OR":	$JSValidation.="
											var field1;
											field1=document.$FormName.$SingleControlName[0].value;
											field2=document.$FormName.$SingleControlName[4].value;
											if(field1=='' && field2=='')
											{
												document.getElementById('$SingleControlName[3]').className='required';
												document.getElementById('$SingleControlName[3]').innerHTML='$SingleControlName[2]';
						...
						case "Number":	$JSValidation.="
											...
											{
												document.getElementById('$SingleControlName[3]').className='required';
												document.getElementById('$SingleControlName[3]').innerHTML='Please enter number only.';
												//document.$FormName.$SingleControlName[0].focus();			
												returnValue=false;
											}
											else
