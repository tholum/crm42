...
// +----------------------------------------------------------------------+ 
// 
// $Id: Contact_Vcard_Parse.php,v 1.2 2003/04/01 17:39:47 ciaweb Exp $ 
...
class Contact_Vcard_Parse /*extends PEAR*/ {
    ...
    */
    ...
    function _parseN($text)
    {
        ...
        return array(
            'family' => $this->splitByComma($tmp[0]),
            'given'  => $this->splitByComma($tmp[1]),
            'addl'   => $this->splitByComma($tmp[2]),
            'prefix' => $this->splitByComma($tmp[3]),
            'suffix' => $this->splitByComma($tmp[4])
        );
    }
    ...
    */
    ...
    function _parseADR($text)
    {
        ...
        return array(
            ...
            'extend'   => $this->splitByComma($tmp[1]),
